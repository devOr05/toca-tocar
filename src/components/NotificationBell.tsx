...
export default function NotificationBell({ userId }: NotificationBellProps) {
    ...
    return (
        <div className="relative">
            ...
            {isOpen && (
                <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-16 sm:top-full w-auto sm:w-80 bg-jazz-surface border border-white/10 rounded-xl shadow-2xl overflow-hidden z-[100] animate-in fade-in zoom-in-95 duration-200">
